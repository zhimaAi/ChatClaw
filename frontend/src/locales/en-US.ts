  ...
  settings: {
    ...
    openclawCron: {
      ...
      dialog: {
        ...
        deliveryChannelPlaceholder: 'For example: last',
        deliveryTo: 'To',
        deliveryToPlaceholder: 'Target conversation or user',
        deliveryAccountId: 'Account ID',
        deliveryAccountIdPlaceholder: 'Optional for multi-account scenarios',
        announce: 'Announce',
