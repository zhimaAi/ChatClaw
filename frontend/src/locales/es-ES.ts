export default {
  ...
  channels: {
    ...
    unbindSuccess: "已解绑助手",
    wechat: {
      emptyTitle: "Aún no se ha añadido ninguna cuenta de WeChat",
      emptyDesc: "Conecta tu WeChat personal mediante el complemento oficial de Tencent OpenClaw escaneando un código QR para empezar a recibir y procesar mensajes de WeChat.",
      addNow: "Añadir ahora",
      configTitle: "Configurar WeChat",
      configSubtitle: "Conecta tu WeChat personal mediante el complemento oficial de Tencent OpenClaw escaneando un código QR",
      howToConnect: "Cómo conectarlo",
      step1: "Conecta tu WeChat personal mediante el complemento oficial de Tencent OpenClaw escaneando un código QR.",
      step3: "Haz clic en «Generar código QR». ClawX instalará y activará el complemento oficial de WeChat en OpenClaw.",
      step4: "Usa WeChat para escanear el código QR de abajo y confirma la conexión en tu teléfono.",
      step5: "Después de conectarte, aparecerá un nuevo chat llamado «WeChat ClawBot» en WeChat. Puedes repetir el flujo del código QR para añadir más cuentas o volver a conectar una cuenta existente.",
      configStepsLink: "Guía de configuración",
      generateQRCode: "Generar código QR",
      generating: "Generando…",
      scanHint: "Usa WeChat para escanear el código QR de abajo y confirma la conexión en tu teléfono.",
      waitingForScan: "Esperando el escaneo…",
      refresh: "Actualizar",
      loginSuccess: "¡WeChat se ha conectado correctamente!",
      assistantPromptTitle: "Vincular asistente",
      assistantPromptDesc: "El asistente principal (main) se vincula por defecto y procesará los mensajes entrantes. Si quieres usar otro asistente, puedes vincular uno existente o crear uno nuevo y asociarlo automáticamente a este canal.",
      useMainAssistant: "Listo (usar asistente principal)",
      bindExistingAssistant: "Vincular un asistente existente",
      createAssistantManually: "Crear asistente nuevo",
      createAssistantHint: "Al crear un asistente nuevo, todavía tendrás que completar manualmente datos como el nombre. Después de crearlo, se vinculará automáticamente y la conexión se actualizará.",
      missingChannelId: "Falta la información del canal. Cierra este diálogo, actualiza la lista de canales y vuelve a intentarlo.",
      missingChannelIdHint: "No se ha podido obtener el ID del canal. Cierra este diálogo y vincula manualmente un asistente desde la lista de canales.",
      channelNotFound: "No se encontró el canal correspondiente. Actualiza y vuelve a intentarlo.",
      pluginInstallTryLater:
        "El complemento oficial de WeChat se está instalando o activando en segundo plano. Vuelve a intentarlo dentro de un momento.",
      editNotSupported:
        "WeChat se conecta mediante código QR y no se puede editar aquí. Para cambiar de cuenta, elimina este canal en la página de canales y vuelve a añadirlo escaneando de nuevo.",
    },
  },
  common: {
    all: "全部",
