export default {
  ...
  channels: {
    ...
    unbindSuccess: "已解绑助手",
    wechat: {
      emptyTitle: "아직 WeChat 계정이 추가되지 않았습니다",
      emptyDesc: "Tencent 공식 OpenClaw 플러그인으로 QR 코드를 스캔해 개인 WeChat을 연결하고, WeChat 메시지를 수신하고 처리하세요.",
      addNow: "지금 추가",
      configTitle: "WeChat 설정",
      configSubtitle: "Tencent 공식 OpenClaw 플러그인으로 QR 코드를 스캔해 개인 WeChat을 연결하세요",
      howToConnect: "연결 방법",
      step1: "Tencent 공식 OpenClaw 플러그인으로 QR 코드를 스캔해 개인 WeChat을 연결하세요.",
      step3: "“QR 코드 생성”을 클릭하세요. ClawX가 OpenClaw에 공식 WeChat 플러그인을 설치하고 활성화합니다.",
      step4: "아래 QR 코드를 WeChat으로 스캔한 뒤 휴대폰에서 연결을 확인하세요.",
      step5: "연결이 완료되면 WeChat에 “WeChat ClawBot”이라는 새 채팅이 자동으로 나타납니다. 같은 QR 절차를 반복해 더 많은 계정을 추가하거나 기존 계정을 다시 연결할 수 있습니다.",
      configStepsLink: "설정 가이드",
      generateQRCode: "QR 코드 생성",
      generating: "생성 중…",
      scanHint: "아래 QR 코드를 WeChat으로 스캔한 뒤 휴대폰에서 연결을 확인하세요.",
      waitingForScan: "스캔 대기 중…",
      refresh: "새로고침",
      loginSuccess: "WeChat 연결에 성공했습니다!",
      assistantPromptTitle: "어시스턴트 연결",
      assistantPromptDesc: "기본적으로 메인 어시스턴트(main)가 연결되어 들어오는 메시지를 처리합니다. 다른 어시스턴트를 사용하려면 기존 어시스턴트를 연결하거나 새로 생성해 이 채널에 자동으로 연결할 수 있습니다.",
      useMainAssistant: "완료 (메인 어시스턴트 사용)",
      bindExistingAssistant: "기존 어시스턴트 연결",
      createAssistantManually: "새 어시스턴트 만들기",
      createAssistantHint: "새 어시스턴트를 만들 때 이름 등의 정보는 직접 입력해야 합니다. 생성이 완료되면 자동으로 연결되고 접속 상태가 새로고침됩니다.",
      missingChannelId: "채널 정보를 가져오지 못했습니다. 이 창을 닫고 채널 목록을 새로고침한 뒤 다시 시도하세요.",
      missingChannelIdHint: "채널 ID를 가져오지 못했습니다. 이 창을 닫고 채널 목록에서 수동으로 어시스턴트를 연결하세요.",
      channelNotFound: "해당 채널을 찾을 수 없습니다. 새로고침 후 다시 시도하세요.",
      pluginInstallTryLater:
        "공식 WeChat 플러그인이 현재 백그라운드에서 설치되거나 활성화되고 있습니다. 잠시 후 다시 시도하세요.",
      editNotSupported:
        "WeChat은 QR 코드로 연결되므로 여기서 편집할 수 없습니다. 계정을 바꾸려면 채널 페이지에서 이 채널을 삭제한 뒤 다시 스캔하여 추가하세요.",
    },
  },
  common: {
    all: "全部",
