export default {
  ...
  scheduledTasks: {
    ...
    form: {
      ...
      clear: "지우기",
      expiredHint: "이 작업은 만료되어 비활성화된 상태입니다. 다시 활성화하려면 만료 시간을 미래 시점으로 변경하세요.",
      expiresAt: "만료 시간",
      monthOption: "{month}월",
      selectExpirationDate: "만료 날짜 선택",
      today: "오늘",
      yearOption: "{year}년",
    },
    confirmDelete: "Delete",
    deleteConfirmTitle: "Confirm Delete",
    deleteConfirmDescription: "\"{name}\" 작업을 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.",
    copy: "복사",
    copySuffix: "복사본",
    expiredCannotEnable: "만료되어 다시 활성화할 수 없습니다",
    notification: {
