export default {
  ...
  toolsPage: {
    ...
    smartSidebar: {
      title: "智慧側邊欄",
      description: "吸附在企微、QQ 等聊天側邊欄，即時查詢 AI",
    },
    selectionSearch: {
      title: "滑詞搜尋",
      description: "文字右鍵複製後跳出 AI 查詢",
    },
    floatingIcon: {
      title: "桌面懸浮圖示",
      description: "桌面懸浮捷徑入口",
    },
    multiask: {
      title: "多問",
      description: "多個 AI 透過網頁同時開啟檢視",
    },
    addToMenuBar: "加入側邊欄",
    removeFromMenuBar: "從側邊欄移除",
  ...
  scheduledTasks: {
    ...
    form: {
      ...
      clear: "清空",
      expiredHint: "該任務已過期，目前保持關閉狀態。如需再次啟用，請將到期時間修改到未來。",
      expiresAt: "到期時間",
      monthOption: "{month} 月",
    ...
    notification: {
      ...
      channelsLabel: "選擇頻道",
      emptyChannels: "目前通知類型下沒有可用頻道",
      hintSelected: "可多選，任務完成後會透過這些頻道傳送結果。",
