export default {
  ...
  channels: {
    ...
    wechat: {
      emptyTitle: "尚未新增微信",
      emptyDesc: "透過騰訊官方 OpenClaw 外掛掃碼連接個人微信，開始接收並處理微信訊息。",
      addNow: "立即新增",
      configTitle: "設定微信",
      configSubtitle: "透過騰訊官方 OpenClaw 外掛掃碼連接個人微信",
      howToConnect: "如何連接",
      step1: "透過騰訊官方 OpenClaw 外掛掃碼連接個人微信。",
      step3: "點擊「產生二維碼」，ClawX 會在 OpenClaw 中安裝並啟用官方微信外掛。",
      step4: "使用微信掃描下方二維碼，並在手機上確認連接。",
      step5: "連接成功後，微信中會自動出現新的「微信 ClawBot」對話。你之後可再次透過掃碼流程新增更多微信帳號，或重新連接既有帳號。",
      configStepsLink: "設定步驟",
      generateQRCode: "產生二維碼",
      generating: "產生中…",
      scanHint: "請使用微信掃描下方二維碼，並在手機上確認連接。",
      waitingForScan: "等待掃碼中…",
      refresh: "重新整理",
      loginSuccess: "微信連接成功！",
      assistantPromptTitle: "關聯助手",
      assistantPromptDesc: "目前已預設關聯主助手（main），訊息會由主助手處理。若需要使用其他助手，可綁定既有助手，或新建助手並自動綁定到此微信頻道。",
      useMainAssistant: "完成（使用主助手）",
      bindExistingAssistant: "綁定既有助手",
      createAssistantManually: "新建助手",
      createAssistantHint: "新建助手時仍需手動填寫名稱等資訊；建立成功後會自動綁定並重新整理連接。",
      missingChannelId: "尚未取得頻道資訊，請關閉此視窗後重新整理頻道清單再試。",
      missingChannelIdHint: "尚未取得頻道 ID，請關閉此視窗後到頻道清單中手動綁定助手。",
      channelNotFound: "找不到對應頻道，請重新整理後再試。",
      pluginInstallTryLater:
        "官方微信外掛正在背景安裝或啟用中，請稍後再試。",
      editNotSupported:
        "微信透過掃碼連接，不支援在此處編輯。如需切換帳號，請先在頻道頁刪除該頻道後重新掃碼新增。",
    },
  },
  common: {
    all: "全部",
