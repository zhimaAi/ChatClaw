export default {
  ...
  channels: {
    ...
    provisioning: {
      toastTitle: '正在背景處理',
      toastDescription: '頻道與 Gateway 仍在建立或同步中，連接狀態將自動更新，請稍候。',
    ...
    wechat: {
      emptyTitle: '尚未新增微信',
      emptyDesc: '透過騰訊官方 OpenClaw 外掛掃描 QR Code 連接個人微信，開始接收並處理微信訊息。',
      addNow: '立即新增',
      configTitle: '設定微信',
      configSubtitle: '透過騰訊官方 OpenClaw 外掛掃描 QR Code 連接個人微信',
      howToConnect: '如何連接',
      step1: '透過騰訊官方 OpenClaw 外掛掃描 QR Code 連接個人微信',
      step3: '點擊產生 QR Code，ClawX 會在 OpenClaw 中安裝並啟用官方微信外掛',
      step4: '請使用微信掃描下方 QR Code，並在手機上確認連接',
      step5: '連接成功後，微信中會自動出現新的「微信 ClawBot」對話。之後也可以再次透過掃碼流程新增更多微信帳號，或重新連接既有帳號。',
      configStepsLink: '設定步驟',
      generateQRCode: '產生 QR Code',
      generating: '產生中…',
      scanHint: '請使用微信掃描下方 QR Code，並在手機上確認連接',
      ...
      createAssistantHint: '建立新助手時需手動填寫名稱等資訊；建立成功後將自動綁定並重新整理連接。',
      ...
      editNotSupported: '微信透過掃碼連接，不支援在此處編輯。如需更換帳號，請在頻道頁刪除此頻道後重新掃碼新增。',
    },
  },
  scheduledTasks: {
