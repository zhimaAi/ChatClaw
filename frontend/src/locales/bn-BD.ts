export default {
  ...
  channels: {
    ...
    card: {
      ...
      unbind: "解绑",
      unbound: "未绑定",
      applicationId: "অ্যাপ্লিকেশন আইডি",
    },
    comingSoon: "即将上线",
    config: {
      appId: "APPID",
    ...
    unbindSuccess: "已解绑助手",
    wechat: {
      emptyTitle: "এখনও কোনো WeChat অ্যাকাউন্ট যোগ করা হয়নি",
      emptyDesc: "Tencent-এর অফিসিয়াল OpenClaw প্লাগইনের মাধ্যমে QR কোড স্ক্যান করে আপনার ব্যক্তিগত WeChat যুক্ত করুন, যাতে WeChat বার্তা গ্রহণ ও প্রক্রিয়া করা যায়।",
      addNow: "এখনই যোগ করুন",
      configTitle: "WeChat কনফিগার করুন",
      configSubtitle: "Tencent-এর অফিসিয়াল OpenClaw প্লাগইনের মাধ্যমে QR কোড স্ক্যান করে আপনার ব্যক্তিগত WeChat যুক্ত করুন",
      howToConnect: "কীভাবে সংযোগ করবেন",
      step1: "Tencent-এর অফিসিয়াল OpenClaw প্লাগইনের মাধ্যমে QR কোড স্ক্যান করে আপনার ব্যক্তিগত WeChat যুক্ত করুন।",
      step3: "\"Generate QR Code\" এ ক্লিক করুন। ClawX OpenClaw-এ অফিসিয়াল WeChat প্লাগইন ইনস্টল ও চালু করবে।",
      step4: "নিচের QR কোডটি WeChat দিয়ে স্ক্যান করুন এবং ফোনে সংযোগ নিশ্চিত করুন।",
      step5: "সংযোগ সম্পন্ন হলে WeChat-এ একটি নতুন \"WeChat ClawBot\" চ্যাট দেখা যাবে। একই QR প্রক্রিয়া ব্যবহার করে আরও অ্যাকাউন্ট যোগ করা বা বিদ্যমান অ্যাকাউন্ট পুনরায় সংযুক্ত করা যাবে।",
      configStepsLink: "সেটআপ নির্দেশিকা",
      generateQRCode: "QR কোড তৈরি করুন",
      generating: "তৈরি করা হচ্ছে…",
      scanHint: "নিচের QR কোডটি WeChat দিয়ে স্ক্যান করুন এবং ফোনে সংযোগ নিশ্চিত করুন।",
      waitingForScan: "স্ক্যানের অপেক্ষায়…",
      refresh: "রিফ্রেশ",
      loginSuccess: "WeChat সফলভাবে সংযুক্ত হয়েছে!",
      assistantPromptTitle: "অ্যাসিস্ট্যান্ট যুক্ত করুন",
      assistantPromptDesc: "ডিফল্টভাবে প্রধান অ্যাসিস্ট্যান্ট (main) যুক্ত থাকবে এবং বার্তা প্রক্রিয়া করবে। অন্য কোনো অ্যাসিস্ট্যান্ট ব্যবহার করতে চাইলে বিদ্যমান অ্যাসিস্ট্যান্ট যুক্ত করতে পারেন, অথবা একটি নতুন অ্যাসিস্ট্যান্ট তৈরি করে এই চ্যানেলে স্বয়ংক্রিয়ভাবে যুক্ত করতে পারেন।",
      useMainAssistant: "সম্পন্ন (প্রধান অ্যাসিস্ট্যান্ট ব্যবহার করুন)",
      bindExistingAssistant: "বিদ্যমান অ্যাসিস্ট্যান্ট যুক্ত করুন",
      createAssistantManually: "নতুন অ্যাসিস্ট্যান্ট তৈরি করুন",
      createAssistantHint: "নতুন অ্যাসিস্ট্যান্ট তৈরি করার সময় নামের মতো তথ্য আপনাকে হাতে পূরণ করতে হবে। তৈরি হয়ে গেলে এটি স্বয়ংক্রিয়ভাবে যুক্ত হবে এবং সংযোগ রিফ্রেশ হবে।",
      missingChannelId: "চ্যানেলের তথ্য পাওয়া যায়নি। এই ডায়ালগ বন্ধ করে চ্যানেল তালিকা রিফ্রেশ করে আবার চেষ্টা করুন।",
      missingChannelIdHint: "চ্যানেল আইডি পাওয়া যায়নি। এই ডায়ালগ বন্ধ করে চ্যানেল তালিকা থেকে হাতে অ্যাসিস্ট্যান্ট যুক্ত করুন।",
      channelNotFound: "সংশ্লিষ্ট চ্যানেল পাওয়া যায়নি। রিফ্রেশ করে আবার চেষ্টা করুন।",
      pluginInstallTryLater:
        "অফিসিয়াল WeChat প্লাগইনটি বর্তমানে ব্যাকগ্রাউন্ডে ইনস্টল বা চালু হচ্ছে। অনুগ্রহ করে একটু পরে আবার চেষ্টা করুন।",
      editNotSupported:
        "WeChat QR কোডের মাধ্যমে সংযুক্ত হয়, তাই এখানে এটি সম্পাদনা করা যাবে না। অ্যাকাউন্ট বদলাতে হলে Channels পেজ থেকে এই চ্যানেল মুছে আবার স্ক্যান করে যোগ করুন।",
    },
  },
  common: {
    all: "全部",
