export default {
  ...
  channels: {
    ...
    unbindSuccess: "已解绑助手",
    wechat: {
      emptyTitle: "Aucun compte WeChat n’a encore été ajouté",
      emptyDesc: "Connectez votre WeChat personnel via le plugin officiel Tencent OpenClaw en scannant un QR code afin de recevoir et traiter les messages WeChat.",
      addNow: "Ajouter maintenant",
      configTitle: "Configurer WeChat",
      configSubtitle: "Connectez votre WeChat personnel via le plugin officiel Tencent OpenClaw en scannant un QR code",
      howToConnect: "Comment se connecter",
      step1: "Connectez votre WeChat personnel via le plugin officiel Tencent OpenClaw en scannant un QR code.",
      step3: "Cliquez sur « Générer le QR code ». ClawX installera et activera le plugin officiel WeChat dans OpenClaw.",
      step4: "Utilisez WeChat pour scanner le QR code ci-dessous et confirmez la connexion sur votre téléphone.",
      step5: "Une fois connecté, une nouvelle conversation « WeChat ClawBot » apparaîtra dans WeChat. Vous pourrez répéter ce processus QR pour ajouter d’autres comptes ou reconnecter un compte existant.",
      configStepsLink: "Guide de configuration",
      generateQRCode: "Générer le QR code",
      generating: "Génération…",
      scanHint: "Utilisez WeChat pour scanner le QR code ci-dessous et confirmez la connexion sur votre téléphone.",
      waitingForScan: "En attente du scan…",
      refresh: "Actualiser",
      loginSuccess: "WeChat connecté avec succès !",
      assistantPromptTitle: "Associer un assistant",
      assistantPromptDesc: "L’assistant principal (main) est associé par défaut et traitera les messages entrants. Si vous souhaitez utiliser un autre assistant, vous pouvez en associer un existant ou en créer un nouveau et le lier automatiquement à ce canal.",
      useMainAssistant: "Terminer (utiliser l’assistant principal)",
      bindExistingAssistant: "Associer un assistant existant",
      createAssistantManually: "Créer un nouvel assistant",
      createAssistantHint: "Lors de la création d’un nouvel assistant, vous devrez toujours renseigner manuellement des informations comme son nom. Une fois créé, il sera associé automatiquement et la connexion sera actualisée.",
      missingChannelId: "Les informations du canal sont manquantes. Fermez cette fenêtre, actualisez la liste des canaux, puis réessayez.",
      missingChannelIdHint: "L’ID du canal est indisponible. Fermez cette fenêtre et associez manuellement un assistant depuis la liste des canaux.",
      channelNotFound: "Le canal correspondant est introuvable. Actualisez puis réessayez.",
      pluginInstallTryLater:
        "Le plugin officiel WeChat est en cours d’installation ou d’activation en arrière-plan. Veuillez réessayer dans un instant.",
      editNotSupported:
        "WeChat est connecté via QR code et ne peut pas être modifié ici. Pour changer de compte, supprimez ce canal depuis la page des canaux puis ajoutez-le à nouveau en le scannant.",
    },
  },
  common: {
    all: "全部",
