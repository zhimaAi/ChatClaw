export default {
  ...
  settings: {
    ...
    general: {
      ...
      toolchain: {
        ...
        openclaw: {
          name: 'OpenClaw 运行环境',
          description:
            'OpenClaw Agent 的 Node.js 运行时环境，包含 openclaw CLI 和网关。从 OSS 下载后安装到 ~/.chatclaw/openclaw/runtime/',
        },
      },
    },
    memory: {
    ...
    openclawSkills: {
      ...
      addSkillCta: '添加技能',
      pageDesc:
        '优先通过已连接的 OpenClaw 网关调用 skills.status；离线时按 OpenClaw 文档扫描状态目录（managed / workspace / bundled / extraDirs）。',
      filterAll: '全部',
      filterBuiltin: '内置',
      filterInstalled: '安装的',
      ...
      noSkillsHint:
        '请确认网关已连接；离线时请按 OpenClaw 文档放置技能（状态目录下 skills、各 workspace-*/skills、bundled 包、openclaw.json 的 skills.load.extraDirs）。',
      ...
      agentBinding: '所属代理',
      gatewayOfflineHint:
        '网关未连接时改为扫描 OpenClaw 约定目录；连接后将优先使用 skills.status。',
      backToList: '返回列表',
      ...
      gateHintLabel: '网关提示',
      previewNoLocalPath:
        '当前项仅来自网关，本地无对应目录时无法预览文件；连接正常且磁盘存在同名技能包时可自动关联路径。',
      add: {
        title: '新增',
