export default {
  ...
  channels: {
    ...
    unbindSuccess: "已解绑助手",
    wechat: {
      emptyTitle: "अभी तक कोई WeChat खाता नहीं जोड़ा गया है",
      emptyDesc: "Tencent के आधिकारिक OpenClaw प्लगइन के जरिए QR कोड स्कैन करके अपना व्यक्तिगत WeChat कनेक्ट करें, ताकि WeChat संदेश प्राप्त और संसाधित किए जा सकें।",
      addNow: "अभी जोड़ें",
      configTitle: "WeChat कॉन्फ़िगर करें",
      configSubtitle: "Tencent के आधिकारिक OpenClaw प्लगइन के जरिए QR कोड स्कैन करके अपना व्यक्तिगत WeChat कनेक्ट करें",
      howToConnect: "कैसे कनेक्ट करें",
      step1: "Tencent के आधिकारिक OpenClaw प्लगइन के जरिए QR कोड स्कैन करके अपना व्यक्तिगत WeChat कनेक्ट करें।",
      step3: "“Generate QR Code” पर क्लिक करें। ClawX, OpenClaw में आधिकारिक WeChat प्लगइन इंस्टॉल और सक्षम करेगा।",
      step4: "नीचे दिए गए QR कोड को WeChat से स्कैन करें और अपने फ़ोन पर कनेक्शन की पुष्टि करें।",
      step5: "कनेक्ट होने के बाद WeChat में “WeChat ClawBot” नाम से एक नई चैट दिखाई देगी। आप इसी QR प्रक्रिया को दोहराकर और खाते जोड़ सकते हैं या किसी मौजूदा खाते को फिर से कनेक्ट कर सकते हैं।",
      configStepsLink: "सेटअप गाइड",
      generateQRCode: "QR कोड बनाएँ",
      generating: "बनाया जा रहा है…",
      scanHint: "नीचे दिए गए QR कोड को WeChat से स्कैन करें और अपने फ़ोन पर कनेक्शन की पुष्टि करें।",
      waitingForScan: "स्कैन की प्रतीक्षा में…",
      refresh: "रिफ्रेश करें",
      loginSuccess: "WeChat सफलतापूर्वक कनेक्ट हो गया!",
      assistantPromptTitle: "असिस्टेंट लिंक करें",
      assistantPromptDesc: "मुख्य असिस्टेंट (main) डिफ़ॉल्ट रूप से जुड़ा रहेगा और आने वाले संदेशों को संभालेगा। यदि आप किसी दूसरे असिस्टेंट का उपयोग करना चाहते हैं, तो आप मौजूदा असिस्टेंट लिंक कर सकते हैं या नया बनाकर उसे इस चैनल से अपने-आप जोड़ सकते हैं।",
      useMainAssistant: "पूर्ण (मुख्य असिस्टेंट का उपयोग करें)",
      bindExistingAssistant: "मौजूदा असिस्टेंट लिंक करें",
      createAssistantManually: "नया असिस्टेंट बनाएँ",
      createAssistantHint: "नया असिस्टेंट बनाते समय नाम जैसी जानकारी आपको अभी भी मैन्युअली भरनी होगी। बन जाने के बाद यह अपने-आप लिंक हो जाएगा और कनेक्शन रिफ्रेश हो जाएगा।",
      missingChannelId: "चैनल की जानकारी उपलब्ध नहीं है। यह डायलॉग बंद करें, चैनल सूची रिफ्रेश करें और फिर से प्रयास करें।",
      missingChannelIdHint: "चैनल आईडी उपलब्ध नहीं है। यह डायलॉग बंद करें और चैनल सूची से मैन्युअली किसी असिस्टेंट को लिंक करें।",
      channelNotFound: "संबंधित चैनल नहीं मिला। रिफ्रेश करके फिर से प्रयास करें।",
      pluginInstallTryLater:
        "आधिकारिक WeChat प्लगइन अभी बैकग्राउंड में इंस्टॉल या सक्षम किया जा रहा है। कृपया थोड़ी देर बाद फिर से प्रयास करें।",
      editNotSupported:
        "WeChat QR कोड के जरिए कनेक्ट होता है, इसलिए इसे यहाँ संपादित नहीं किया जा सकता। खाता बदलने के लिए Channels पेज से इस चैनल को हटाएँ और दोबारा स्कैन करके जोड़ें।",
    },
  },
  common: {
    all: "全部",
