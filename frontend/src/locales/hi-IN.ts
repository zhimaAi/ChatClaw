export default {
  ...
  scheduledTasks: {
    ...
    form: {
      ...
      clear: "साफ़ करें",
      expiredHint: "यह कार्य समाप्त हो चुका है और अभी बंद है। इसे फिर से चालू करने के लिए समाप्ति समय को भविष्य की तारीख पर बदलें।",
      expiresAt: "समाप्ति समय",
      monthOption: "माह {month}",
    ...
    notification: {
      ...
      hintSelected: "आप कई चैनल चुन सकते हैं। कार्य पूरा होने पर परिणाम वहां भेजे जाएंगे।",
      hintUnselected: "पहले सूचना प्रकार चुनें, फिर संबंधित प्लेटफ़ॉर्म से एक या अधिक चैनल चुनें।",
      label: "सूचना",
      none: "सूचना न भेजें",
      optional: "वैकल्पिक",
      selectChannel: "कृपया चैनल चुनें",
      selectTypeFirst: "कृपया पहले सूचना प्रकार चुनें",
    },
    operationLog: {
      columns: {
        action: "क्रिया",
