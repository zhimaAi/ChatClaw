export default {
  ...
  settings: {
    ...
    menu: {
      ...
      runtimeEnvironment: 'بيئة التشغيل',
    },
    openclawRuntime: {
      title: 'خدمة OpenClaw',
      ...
      gatewayLog: 'سجل البوابة',
      resetConfirmDesc: 'سيؤدي هذا الاجراء لحذف جميع مجلدات تخزين بيانات OpenClaw، بما في ذلك المكونات الاضافية وسجل المحادثات وتكوين القنوات وما إلى ذلك.لا يمكن التراجع عن هذا الاجراء، هل تريد المتابعة؟',
      resetConfirmTitle: 'تاكيد اعادة ضبط المصنع',
      resetFailed: 'فشل اعادة ضبط المصنع',
      resetToFactory: 'اعادة ضبط المصنع',
      resetToFactoryHint: 'حذف دليل بيانات OpenClaw واعادة تشغيل التطبيق،适用于环境异常需要恢复出厂设置的情况',
      viewGatewayLog: 'عرض السجل',
      waitingForLog: 'في انتظار مخرجات السجل...',
    },
    general: {
      ...
      toolchain: {
        ...
        openclaw: {
          ...
          description: 'تثبيت وإدارة بيئة تشغيل OpenClaw بنقرة واحدة، تدعم سير عمل الوكيل وقدرات سلسلة الادوات.',
        },
    ...
    chatwiki: {
      ...
      openSourceLoginHint: 'الحساب الحالي هو حساب اصدار مفتوح المصدر، لا يدعم استخدام النماذج والائتمان الخاص بـ chatwiki',
      openSourceVersion: 'اصدار مفتوح المصدر',
      openSourceVersionHint: 'يدعم فقط مزامنة قاعدة المعارف/التطبيق',
      openSourceVersionLogin: 'حساب الاصدار مفتوح المصدر',
      openclawDescription: 'الترخيص وربط chatwiki، واستخدام النماذج والائتمان الخاص بـ chatwiki',
      switchBinding: 'تبديل الربط',
    },
    tools: {
      tray: {
        title: 'صينية النظام',
    ...
    runtimeEnvironment: {
      installNow: 'تثبيت',
      installedHint: 'تم تثبيت بيئة تشغيل openclaw، إذا كنت لا تستخدمها مؤقتًا، يمكنك تعطيلها بالنقر بزر الفارة الايسر، يمكنك الذهاب لاحقًا إلى',
      later: 'انتظر لحظة',
      managerSuffix: 'تعطيل في',
      managerText: 'مدير openclaw',
      notInstalledHint: 'لم يتم تثبيت بيئة تشغيل openclaw، يرجى اكمال التثبيت اولا.',
      pause: 'ايقاف مؤقت',
      pauseFailed: 'فشل الايقاف المؤقت',
      paused: 'تم ايقاف التنزيل',
      startUsing: 'ابدأ الاستخدام',
      subtitle: 'قبل استخدام openclaw، يرجى تثبيت بيئة تشغيل openclaw',
      title: 'تثبيت بيئة التشغيل',
    },
    skillMarket: {
      actionInstallSkill: 'تثبيت المهارة',
      addSkillChoosePackageDesc: 'فتح الدليل المقابل، ووضع حزمة المهارات التي تم تنزيلها فيه.',
      addSkillChoosePackageGuideDesc: 'البحث عن المهارات المطلوبة، وتنزيل ملفات التثبيت إلى الدليل المقابل.',
      addSkillChoosePackageGuideLabel: 'زيارة ClawHub',
      addSkillChoosePackageTitle: 'اختيار حزمة المهارات',
      addSkillDialogTitle: 'اضافة مهارة',
      addSkillHint: 'اضافة مهارة مشتركة',
      addSkillHintDesc: 'إنشاء مجلد جديد في الدليل المفتوح، وإضافة ملف SKILL.md لإنشاء مهارة مشتركة.',
      addSkillHintDescShared: 'إنشاء مجلد جديد في دليل {dir}، وإضافة ملف SKILL.md لإنشاء مهارة مشتركة.',
      addSkillViaChatDesc: 'المحادثة مع الذكاء الاصطناعي، دعه يساعدك في تصميم اسم المهارة والوصف وخطة التنفيذ.',
      addSkillViaChatGuideDesc: 'البحث عن المهارات المطلوبة، ونسخ تلميح التثبيت وإرساله إلى الوكيل.',
      addSkillViaChatGuideLabel: 'زيارة SkillHub',
      addSkillViaChatTitle: 'الانشاء من خلال المحادثة',
      agentNone: 'لا شيء',
      agentWorkspaceDirHint: 'يرجى تحديد وكيل اولاً',
      agentWorkspaceDirLoading: 'جار تحميل الدليل...',
      badgeBuiltIn: 'مهام مضمنة',
      badgeWorkspace: 'مساحة العمل',
      builtInCannotUninstall: 'لا يمكن إلغاء تثبيت المهارات المضمنة',
      builtInUninstallHint: 'هذه المهارة مهارة مضمنة، يتم توفيرها مع البرنامج، لا يمكن إلغاء تثبيتها.',
      deleteConfirm: 'هل أنت متاكد من إلغاء تثبيت المهارة',
      disable: 'تعطيل',
      enable: 'تمكين',
      filePreviewNA: 'معاينة الملفات البعيدة غير متاحة مؤقتًا',
      filterAll: 'الكل',
      installConfirmDescription: 'هل أنت متاكد من تثبيت {skill} في {target}؟',
      installDescription: 'اختر الدليل لتثبيت المهارة فيه',
      installFailed: 'فشل التثبيت',
      installSuccess: 'تم التثبيت بنجاح',
      installTitle: 'اختر هدف التثبيت',
      introTitle: 'مقدمة المهارة',
      listHeading: 'سوق المهارات',
      listSubheading: 'تنزيل مهارات الذكاء الاصطناعي من بعيد إلى المحلي',
      loadFailed: 'فشل التحميل، يرجى المحاولة لاحقًا',
      loadMore: 'تحميل المزيد',
      loadingAgents: 'جار تحميل الوكيل...',
      loadingTargets: 'جار تحميل الهدف...',
      noSkills: 'لا توجد مهارات',
      noSkillsHint: 'جرب فئات او كلمات بحث مختلفة',
      openDir: 'فتح الدليل',
      openMainWorkspaceSkillsDir: 'فتح دليل مهارات مساحة العمل الرئيسية',
      refreshCta: 'تحديث',
      scopeAgentOption: 'مهام الوكيل',
      scopeSharedOption: 'مهام مشتركة',
      searchPlaceholder: 'البحث عن المهارات...',
      securityVerifiedHint: 'تم التحقق من الامان والامتثال، لا توجد مخاطر من التعليمات البرمجية الضارة أو تسرب البيانات.',
      selectAgent: 'Agent',
      selectTarget: 'هدف التثبيت',
      sourceChatclaw: 'ChatClaw',
      sourceClawhub: 'ClawHub',
      sourceSkillhub: 'SkillHub',
      statusInstalled: 'مثبت',
      statusInstalling: 'جار التثبيت',
      syncFailedDescription: 'لا يمكن الاتصال بخدمة الواجهة الخلفية',
      syncFailedTitle: 'فشلت مزامنة سوق المهارات',
      tabBrowse: 'مكتبة المهارات',
      tabInstalled: 'مهاراتي',
      targetAgentWorkspace: 'دليل عمل الوكيل',
      targetLocal: 'الدليل المحلي',
      targetOpenClawShared: 'مهام OpenClaw المشتركة',
      targetOpenClawWorkspace: 'مساحة عمل OpenClaw',
      title: 'سوق المهارات',
      toggleFailed: 'فشل التبديل، يرجى المحاولة لاحقًا',
      uninstallFailed: 'فشل إلغاء التثبيت',
      uninstallSuccess: 'تم إلغاء التثبيت بنجاح',
      usageTitle: 'كيف تستخدم؟',
  ...
  assistant: {
    ...
    settings: {
      ...
      model: {
        ...
        unlimited: 'غير محدود',
        setDefaultModelDesc: 'المساعد "{name}" لم يتم تعيين نموذج افتراضي، يرجى تحديد نموذج للمتابعة.',
        setDefaultModelTitle: 'تعيين النموذج الافتراضي',
      },
      retrieval: {
