export default {
  ...
  channels: {
    ...
    wechat: {
      ...
      emptyDesc: "اربط حساب WeChat الشخصي عبر إضافة Tencent OpenClaw الرسمية باستخدام رمز QR لبدء استقبال رسائل WeChat ومعالجتها.",
      addNow: "أضف الآن",
      configTitle: "إعداد WeChat",
      configSubtitle: "اربط حساب WeChat الشخصي عبر إضافة Tencent OpenClaw الرسمية باستخدام رمز QR",
      howToConnect: "كيفية الاتصال",
      step1: "اربط حساب WeChat الشخصي عبر إضافة Tencent OpenClaw الرسمية باستخدام رمز QR.",
      step3: "انقر على \"إنشاء رمز QR\". سيقوم ClawX بتثبيت إضافة WeChat الرسمية وتمكينها في OpenClaw.",
      step4: "استخدم WeChat لمسح رمز QR أدناه ثم أكّد الاتصال على هاتفك.",
      step5: "بعد الاتصال، ستظهر محادثة جديدة باسم \"WeChat ClawBot\" داخل WeChat. ويمكنك تكرار عملية رمز QR لإضافة مزيد من الحسابات أو إعادة ربط حساب موجود.",
      configStepsLink: "دليل الإعداد",
      generateQRCode: "إنشاء رمز QR",
      generating: "جارٍ الإنشاء…",
      scanHint: "استخدم WeChat لمسح رمز QR أدناه ثم أكّد الاتصال على هاتفك.",
      waitingForScan: "بانتظار المسح…",
      refresh: "تحديث",
      loginSuccess: "تم ربط WeChat بنجاح!",
      assistantPromptTitle: "ربط المساعد",
      assistantPromptDesc: "يتم ربط المساعد الرئيسي (main) افتراضيًا وسيتولى معالجة الرسائل الواردة. إذا أردت استخدام مساعد آخر، يمكنك ربط مساعد موجود أو إنشاء مساعد جديد وربطه بهذه القناة تلقائيًا.",
      useMainAssistant: "تم (استخدام المساعد الرئيسي)",
      bindExistingAssistant: "ربط مساعد موجود",
      createAssistantManually: "إنشاء مساعد",
      createAssistantHint: "عند إنشاء مساعد جديد، ستظل بحاجة إلى إدخال معلومات مثل الاسم يدويًا. وبعد الإنشاء سيتم ربطه تلقائيًا وتحديث الاتصال.",
      missingChannelId: "معلومات القناة غير متاحة. أغلق هذه النافذة وحدّث قائمة القنوات ثم حاول مرة أخرى.",
      missingChannelIdHint: "معرّف القناة غير متاح. أغلق هذه النافذة ثم اربط مساعدًا يدويًا من قائمة القنوات.",
      channelNotFound: "تعذر العثور على القناة المطلوبة. حدّث القائمة ثم حاول مرة أخرى.",
      pluginInstallTryLater:
        "تجري حاليًا عملية تثبيت إضافة WeChat الرسمية أو تفعيلها في الخلفية. يرجى المحاولة مرة أخرى بعد قليل.",
      editNotSupported:
        "يتم ربط WeChat عبر رمز QR ولا يمكن تعديله من هنا. لتبديل الحساب، احذف هذه القناة من صفحة القنوات ثم أعد إضافتها عبر المسح.",
    },
  },
  common: {
    all: "全部",
