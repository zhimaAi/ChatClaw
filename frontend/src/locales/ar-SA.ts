export default {
  ...
  scheduledTasks: {
    ...
    form: {
      ...
      clear: "مسح",
      expiredHint: "انتهت صلاحية هذه المهمة وهي الآن معطلة. لإعادة تفعيلها، غيّر وقت الانتهاء إلى وقت مستقبلي.",
      expiresAt: "وقت الانتهاء",
      monthOption: "الشهر {month}",
    ...
    notification: {
      ...
      hintSelected: "يمكنك اختيار عدة قنوات. سيتم إرسال النتائج إليها بعد اكتمال المهمة.",
      hintUnselected: "اختر نوع الإشعار أولاً، ثم اختر قناة واحدة أو أكثر من المنصة المقابلة.",
      label: "الإشعار",
      none: "عدم إرسال إشعارات",
      optional: "اختياري",
      selectChannel: "يرجى اختيار القنوات",
      selectTypeFirst: "يرجى اختيار نوع الإشعار أولاً",
    },
    operationLog: {
      columns: {
        action: "الإجراء",
