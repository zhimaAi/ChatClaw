export default {
  ...
  tools: {
    ...
    skillSearch: { name: 'بحث المهارة' },
    skillList: { name: 'قائمة المهارات' },
    skillInstall: { name: 'تثبيت المهارة' },
    skillUninstall: { name: 'إلغاء تثبيت المهارة' },
    skillEnable: { name: 'تفعيل المهارة' },
    skillDisable: { name: 'تعطيل المهارة' },
    skillOpenFolder: { name: 'فتح مجلد المهارة' },
    ls: { name: 'سرد المجلد' },
    readFile: { name: 'قراءة الملف' },
    writeFile: { name: 'كتابة الملف' },
    editFile: { name: 'تعديل الملف' },
    patchFile: { name: 'ملف التصحيح' },
    glob: { name: 'مطابقة الملفات' },
    grep: { name: 'البحث في النص' },
    executeBackground: { name: 'التنفيذ في الخلفية' },
    taskCreate: { name: 'إنشاء مهمة' },
    taskGet: { name: 'الحصول على مهمة' },
    taskUpdate: { name: 'تحديث المهمة' },
    taskList: { name: 'قائمة المهام' },
    skill: { name: 'تحميل المهارة' },
    writeTodos: { name: 'تخطيط المهام' },
    task: { name: 'مهمة فرعية (قد تستغرق وقتًا)' },
  },
  winsnap: {
    title: 'ChatClaw',
  ...
  settings: {
    ...
    memory: {
      ...
      embeddingEmbeddingDimensionlHint: 'يُستخدم لتحويل نص الذاكرة إلى ناقلات للبحث الدلالي في المحادثات.',
    ...
    skills: {
      ...
      noSkillsHint: 'تصفح وتثبيت المهارات من علامة تبويب "السوق"',
    ...
    mcp: {
      title: 'MCP',
      enable: 'تفعيل MCP',
      enableHint: 'عند التفعيل، سيقوم مساعد الذكاء الاصطناعي بالاتصال واستخدام خوادم MCP المكونة تلقائيًا.',
      directory: 'دليل تكوين MCP',
      directoryHint: 'ضع ملفات تكوين خادم MCP في هذا الدليل. سيتم اكتشافها والاتصال بها تلقائيًا.',
      tabServers: 'MCP',
      ...
      addServer: 'إضافة',
      validateAll: 'التحقق من جميع خوادم MCP المفعلة',
      validateAllPassed: 'جميع خوادم MCP المفعلة اجتازت التحقق',
      validateDisabled: 'تم تعطيل {count} خادم MCP غير متاح',
      ...
      noServers: 'لا توجد خوادم MCP مكونة',
      noServersHint: 'انقر على زر "إضافة" لتكوين خادم MCP',
      deleteConfirm: 'هل أنت متأكد من حذف خادم MCP هذا؟',
      deleteSuccess: 'تم الحذف بنجاح',
      deleteFailed: 'فشل الحذف',
    ...
    snap: {
      ...
      deleteCustomConfirmDesc: 'هل تريد حذف تكوين الالتقاط لـ "{name}"؟',
    ...
    chatwiki: {
      ...
      startUsingHint: 'انقر على "ابدأ" أدناه لمواصلة استخدام ChatClaw Desktop',
    ...
    modelService: {
      enabled: 'مفعل',
      disableBlockedByEmbedding: 'هذا المزود قيد الاستخدام كنموذج تضمين عام، يرجى التغيير في "إعدادات نموذج التضمين" قبل التعطيل',
      disableBlockedByAgent: 'هذا المزود قيد الاستخدام كنموذج افتراضي بواسطة المساعد "{name}"، يرجى تغيير إعدادات المساعد قبل التعطيل',
      deleteBlockedByAgent: 'هذا النموذج قيد الاستخدام كنموذج افتراضي بواسطة المساعد "{name}"، يرجى تغيير إعدادات المساعد قبل الحذف',
      apiKey: 'مفتاح API',
      ...
      deleteConfirmMessage: 'هل أنت متأكد من حذف النموذج "{name}"؟ لا يمكن التراجع عن هذا الإجراء.',
      confirmDelete: 'حذف',
      deleting: 'جار الحذف...',
  ...
  assistant: {
    ...
    channels: {
      title: 'قنوات المساعد',
      subtitle: 'أضف وربط قنوات المراسلة لـ "{name}"',
    ...
    conversation: {
      ...
      delete: {
        title: 'تأكيد الحذف',
        desc: 'حذف المحادثة "{name}"؟ لا يمكن التراجع عن هذا الإجراء.',
        cancel: 'إلغاء',
        confirm: 'حذف',
        success: 'تم الحذف',
      },
    ...
    settings: {
      ...
      delete: {
        ...
        confirmDesc: 'هل أنت متأكد من حذف "{name}"؟ لا يمكن التراجع عن هذا الإجراء.',
      },
    },
    workspaceDrawer: {
      title: 'مساحة العمل',
      ...
      mcpNoServers: 'لا توجد خوادم MCP متاحة',
      mcpAddFromGlobal: 'إضافة من قائمة MCP العالمية',
      mcpEmptyHint: 'انقر + للإضافة من قائمة MCP العالمية',
      mcpPickerHint: 'تبديل لإضافة أو إزالة خوادم MCP لهذا المساعد',
      mcpNoAvailableToAdd: 'لا توجد خوادم MCP متاحة للإضافة.فعّل بعضًا في الإعدادات أولاً.',
      ...
      mcpGlobalDisabled: 'MCP معطل عالميًا.فعّله في الإعدادات.',
      mcpGoToSettings: 'إضافة MCP جديد',
      mcpGoToSettingsHint: 'انتقل إلى صفحة الإعدادات لإضافة خادم MCP جديد',
    },
  },
  knowledge: {
    help: {
    ...
    delete: {
      title: 'تأكيد الحذف',
      desc: 'حذف قاعدة المعرفة "{name}"؟ لا يمكن التراجع عن هذا الإجراء.',
      cancel: 'إلغاء',
      confirm: 'حفظ',
      success: 'تم الحذف',
      failed: 'فشل الحذف',
    ...
    content: {
      ...
      delete: {
        title: 'تأكيد الحذف',
        desc: 'هل أنت متأكد من حذف "{name}"؟ لا يمكن التراجع عن هذا الإجراء.',
        cancel: 'إلغاء',
        confirm: 'حذف',
        success: 'تم الحذف',
        failed: 'فشل الحذف',
    ...
    folder: {
      ...
      deleteDesc: 'بعد حذف المجلد "{name}"، ستنتقل وثائقه إلى "غير مصنف". لا يمكن التراجع عن هذا الإجراء.',
      deleteCancel: 'إلغاء',
      deleteConfirm: 'حذف',
    ...
    viewer: {
      ...
      unsupported: 'نوع الملف "{type}" غير مدعوم للمعاينة. يرجى الفتح خارجيًا.',
  ...
  channels: {
    ...
    delete: {
      title: 'تأكيد الحذف',
      desc: 'هل أنت متأكد من حذف القناة "{name}"؟ لا يمكن التراجع عن هذا الإجراء.',
