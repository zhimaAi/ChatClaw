export default {
  ...
  settings: {
    ...
    menu: {
      ...
      runtimeEnvironment: 'Calistirma ortami',
    },
    openclawRuntime: {
      ...
      gatewayLog: 'Agizlik gunlugu',
      resetConfirmDesc: 'Bu islem, eklentiler, gorusme gecmisi, kanal yapilandirmalari vb. dahil olmak uzere OpenClaw"un tum veri depolama klasorlerini silecektir. Bu islem geri alinamaz. Devam etmek istiyor musunuz?',
      resetConfirmTitle: 'Fabrika ayarlarina sifirlamayi onayla',
      resetFailed: 'Fabrika ayarlarina sifirlama basarisiz',
      resetToFactory: 'Fabrika ayarlarina sifirla',
      resetToFactoryHint: 'OpenClaw veri dizinini silin ve uygulamayi yeniden baslatin,适用于环境异常需要恢复出厂设置的情况',
      viewGatewayLog: 'Günlugu goruntule',
      waitingForLog: 'Gunluk ciktisi bekleniyor...',
    },
    general: {
      title: 'Genel ayarlar',
      language: 'Dil',
      ...
      toolchain: {
        ...
        openclaw: {
          ...
          description: 'OpenClaw calistirma ortamini tek tikla kurulum ve yonetim, ajan is akislari ve araç zinciri yeteneklerini destekler.',
        },
    ...
    chatwiki: {
      ...
      cloudVersion: 'Bulut surumu',
      openSourceLoginHint: 'Mevcut hesap acik kaynak surum hesabidir ve chatwiki"nin kendi modellerini ve kredilerini kullanmayi desteklemez',
      openSourceVersion: 'Acik kaynak surumu',
      openSourceVersionHint: 'Yalnızca bilgi tabani/uygulama senkronizasyonunu destekler',
      openSourceVersionLogin: 'Acik kaynak surum hesabi',
      openclawDescription: 'chatwiki"yi yetkilendirin ve baglayin, chatwiki"nin kendi modellerini ve hesap kredilerini kullanin',
      switchBinding: 'Baglantiyi degistir',
    },
    tools: {
      tray: {
    ...
    runtimeEnvironment: {
      installNow: 'Kur',
      installedHint: 'OpenClaw calistirma ortami kuruludur. Gecici olarak kullanmiyorsaniz, sol tikla devre disi birakabilirsiniz. Daha sonra gidebilirsiniz',
      later: 'Bekle',
      managerSuffix: 'Devre disi birak',
      managerText: 'OpenClaw yoneticisi',
      notInstalledHint: 'OpenClaw calistirma ortami henuz kurulmamistir. Lutfen once kurulumu tamamlayin.',
      pause: 'Duraklat',
      pauseFailed: 'Duraklatma basarisiz',
      paused: 'Indirme duraklatildi',
      startUsing: 'Kullanmaya basla',
      subtitle: 'OpenClaw"u kullanmadan once lutfen OpenClaw calistirma ortamini kurun',
      title: 'Calistirma ortamini kur',
    },
    skillMarket: {
      actionInstallSkill: 'Yetenek kur',
      addSkillChoosePackageDesc: 'Ilgili dizini acin ve indirilen yetenek paketini icine koyun.',
      addSkillChoosePackageGuideDesc: 'Ihtiyac duydugunuz yetenekleri arayin ve kurulum dosyalarini ilgili dizine indirin.',
      addSkillChoosePackageGuideLabel: 'ClawHub"i ziyaret edin',
      addSkillChoosePackageTitle: 'Yetenek paketi secin',
      addSkillDialogTitle: 'Yetenek ekle',
      addSkillHint: 'Paylasilan yetenek ekle',
      addSkillHintDesc: 'Acilan dizinde yeni bir klasor olusturun ve paylasilan yetenek olusturmak icin bir SKILL.md dosyasi ekleyin.',
      addSkillHintDescShared: '{dir} dizininde yeni bir klasor olusturun ve paylasilan yetenek olusturmak icin bir SKILL.md dosyasi ekleyin.',
      addSkillViaChatDesc: 'AI ile sohbet edin ve yetenek adi, aciklamasi ve uygulama planini tasarlamasina yardimci olmasini saglayin.',
      addSkillViaChatGuideDesc: 'Ihtiyac duydugunuz yetenekleri arayin, kurulum ipucunu kopyalayin ve Ajan"a gonderin.',
      addSkillViaChatGuideLabel: 'SkillHub"i ziyaret edin',
      addSkillViaChatTitle: 'Sohbet yoluyla olustur',
      agentNone: 'Yok',
      agentWorkspaceDirHint: 'Lutfen once bir Ajan secin',
      agentWorkspaceDirLoading: 'Dizin yukleniyor...',
      badgeBuiltIn: 'Yerlesik yetenekler',
      badgeWorkspace: 'Calisma alani',
      builtInCannotUninstall: 'Yerlesik yetenekler kaldirilamaz',
      builtInUninstallHint: 'Bu yetenek, yazilimla birlikte saglanan yerlesik bir yetenektir. Kaldirilamaz.',
      deleteConfirm: 'Yetenegi kaldirmak istediginizden emin misiniz',
      disable: 'Devre disi birak',
      enable: 'Etkinlestir',
      filePreviewNA: 'Uzak dosya onizlemesi su an kullanilamiyor',
      filterAll: 'Tumu',
      installConfirmDescription: '{skill}"i {target}"e kurmak istediginizden emin misiniz?',
      installDescription: 'Yetenegin kurulacagi dizini secin',
      installFailed: 'Kurulum basarisiz',
      installSuccess: 'Basariyla kuruldu',
      installTitle: 'Kurulum hedefi secin',
      introTitle: 'Yetenek tanitimi',
      listHeading: 'Yetenek pazar',
      listSubheading: 'AI yeteneklerini uzaktan yerel olarak indir',
      loadFailed: 'Yukleme basarisiz, lutfen daha sonra tekrar deneyin',
      loadMore: 'Daha fazla yukle',
      loadingAgents: 'Ajan yukleniyor...',
      loadingTargets: 'Hedef yukleniyor...',
      noSkills: 'Yetenek yok',
      noSkillsHint: 'Diger kategorileri veya arama anahtar kelimelerini deneyin',
      openDir: 'Dizini ac',
      openMainWorkspaceSkillsDir: 'Ana calisma alani yetenek dizinini ac',
      refreshCta: 'Yenile',
      scopeAgentOption: 'Ajan yetenekleri',
      scopeSharedOption: 'Paylasilan yetenekler',
      searchPlaceholder: 'Yetenekleri ara...',
      securityVerifiedHint: 'Guvence ve uyumluluk acisindan dogrulanmistir, kotu niyetli kod veya veri sizintisi riski yoktur.',
      selectAgent: 'Agent',
      selectTarget: 'Kurulum hedefi',
      sourceChatclaw: 'ChatClaw',
      sourceClawhub: 'ClawHub',
      sourceSkillhub: 'SkillHub',
      statusInstalled: 'Kurulu',
      statusInstalling: 'Kuruluyor',
      syncFailedDescription: 'Arka uç servise baglanilamiyor',
      syncFailedTitle: 'Yetenek pazari senkronizasyonu basarisiz',
      tabBrowse: 'Yetenek kitapligi',
      tabInstalled: 'Yeteneklerim',
      targetAgentWorkspace: 'Ajan calisma dizini',
      targetLocal: 'Yerel dizin',
      targetOpenClawShared: 'OpenClaw paylasilan yetenekleri',
      targetOpenClawWorkspace: 'OpenClaw calisma alani',
      title: 'Yetenek pazar',
      toggleFailed: 'Gecis basarisiz, lutfen daha sonra tekrar deneyin',
      uninstallFailed: 'Kaldirma basarisiz',
      uninstallSuccess: 'Basariyla kaldirildi',
      usageTitle: 'Nasil kullanilir?',
      viewDetail: 'Ayrintilari goster',
    },
  },
  assistant: {
    ...
    settings: {
      ...
      model: {
        ...
        unlimited: 'Sınırsız',
        setDefaultModelDesc: 'Asistan "{name}" icin varsayilan model ayarlanmamis. Devam etmek icin bir model secin.',
        setDefaultModelTitle: 'Varsayilan modeli ayarla',
      },
      retrieval: {
