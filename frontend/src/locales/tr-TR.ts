export default {
  ...
  channels: {
    ...
    unbindSuccess: "已解绑助手",
    wechat: {
      emptyTitle: "Henüz WeChat hesabı eklenmedi",
      emptyDesc: "WeChat mesajlarını almaya ve işlemeye başlamak için kişisel WeChat hesabınızı Tencent’in resmi OpenClaw eklentisi üzerinden QR kod tarayarak bağlayın.",
      addNow: "Şimdi ekle",
      configTitle: "WeChat’i yapılandır",
      configSubtitle: "Kişisel WeChat hesabınızı Tencent’in resmi OpenClaw eklentisi üzerinden QR kod tarayarak bağlayın",
      howToConnect: "Nasıl bağlanır",
      step1: "Kişisel WeChat hesabınızı Tencent’in resmi OpenClaw eklentisi üzerinden QR kod tarayarak bağlayın.",
      step3: "“QR Kod Oluştur”a tıklayın. ClawX, OpenClaw içinde resmi WeChat eklentisini kurup etkinleştirecektir.",
      step4: "Aşağıdaki QR kodu WeChat ile tarayın ve telefonunuzda bağlantıyı onaylayın.",
      step5: "Bağlandıktan sonra WeChat içinde otomatik olarak yeni bir “WeChat ClawBot” sohbeti görünür. Aynı QR akışını kullanarak daha fazla hesap ekleyebilir veya mevcut bir hesabı yeniden bağlayabilirsiniz.",
      configStepsLink: "Kurulum kılavuzu",
      generateQRCode: "QR kod oluştur",
      generating: "Oluşturuluyor…",
      scanHint: "Aşağıdaki QR kodu WeChat ile tarayın ve telefonunuzda bağlantıyı onaylayın.",
      waitingForScan: "Tarama bekleniyor…",
      refresh: "Yenile",
      loginSuccess: "WeChat başarıyla bağlandı!",
      assistantPromptTitle: "Asistanı bağla",
      assistantPromptDesc: "Varsayılan olarak ana asistan (main) bağlanır ve gelen mesajları işler. Farklı bir asistan kullanmak isterseniz mevcut bir asistanı bağlayabilir veya yeni bir tane oluşturup bu kanala otomatik olarak bağlayabilirsiniz.",
      useMainAssistant: "Tamam (ana asistanı kullan)",
      bindExistingAssistant: "Mevcut asistanı bağla",
      createAssistantManually: "Yeni asistan oluştur",
      createAssistantHint: "Yeni bir asistan oluştururken ad gibi bilgileri yine manuel olarak girmeniz gerekir. Oluşturulduktan sonra otomatik olarak bağlanır ve bağlantı yenilenir.",
      missingChannelId: "Kanal bilgisi eksik. Bu pencereyi kapatın, kanal listesini yenileyin ve tekrar deneyin.",
      missingChannelIdHint: "Kanal kimliği alınamadı. Bu pencereyi kapatın ve kanal listesinden bir asistanı manuel olarak bağlayın.",
      channelNotFound: "İlgili kanal bulunamadı. Yenileyip tekrar deneyin.",
      pluginInstallTryLater:
        "Resmi WeChat eklentisi arka planda yükleniyor veya etkinleştiriliyor. Lütfen biraz sonra tekrar deneyin.",
      editNotSupported:
        "WeChat QR kod ile bağlanır ve burada düzenlenemez. Hesap değiştirmek için bu kanalı Kanallar sayfasından silin ve yeniden tarayarak tekrar ekleyin.",
    },
  },
  common: {
    all: "全部",
