export default {
  ...
  channels: {
    ...
    unbindSuccess: "已解绑助手",
    wechat: {
      emptyTitle: "Noben račun WeChat še ni dodan",
      emptyDesc: "Povežite svoj osebni WeChat prek uradnega vtičnika Tencent OpenClaw s skeniranjem QR-kode, da začnete prejemati in obdelovati sporočila WeChat.",
      addNow: "Dodaj zdaj",
      configTitle: "Nastavi WeChat",
      configSubtitle: "Povežite svoj osebni WeChat prek uradnega vtičnika Tencent OpenClaw s skeniranjem QR-kode",
      howToConnect: "Kako se povezati",
      step1: "Povežite svoj osebni WeChat prek uradnega vtičnika Tencent OpenClaw s skeniranjem QR-kode.",
      step3: "Kliknite »Ustvari QR-kodo«. ClawX bo v OpenClaw namestil in omogočil uradni vtičnik WeChat.",
      step4: "Z aplikacijo WeChat skenirajte spodnjo QR-kodo in na telefonu potrdite povezavo.",
      step5: "Po povezavi se bo v WeChat samodejno prikazal nov klepet »WeChat ClawBot«. Enak postopek z QR-kodo lahko ponovite za dodajanje več računov ali ponovno povezavo obstoječega računa.",
      configStepsLink: "Vodič za nastavitev",
      generateQRCode: "Ustvari QR-kodo",
      generating: "Ustvarjanje…",
      scanHint: "Z aplikacijo WeChat skenirajte spodnjo QR-kodo in na telefonu potrdite povezavo.",
      waitingForScan: "Čakanje na skeniranje…",
      refresh: "Osveži",
      loginSuccess: "WeChat je uspešno povezan!",
      assistantPromptTitle: "Poveži pomočnika",
      assistantPromptDesc: "Glavni pomočnik (main) je privzeto povezan in bo obdeloval dohodna sporočila. Če želite uporabiti drugega pomočnika, lahko povežete obstoječega ali ustvarite novega in ga samodejno povežete s tem kanalom.",
      useMainAssistant: "Končano (uporabi glavnega pomočnika)",
      bindExistingAssistant: "Poveži obstoječega pomočnika",
      createAssistantManually: "Ustvari novega pomočnika",
      createAssistantHint: "Pri ustvarjanju novega pomočnika boste morali podatke, kot je ime, še vedno vnesti ročno. Po ustvarjanju bo samodejno povezan in povezava se bo osvežila.",
      missingChannelId: "Podatki o kanalu manjkajo. Zaprite to okno, osvežite seznam kanalov in poskusite znova.",
      missingChannelIdHint: "ID kanala ni na voljo. Zaprite to okno in ročno povežite pomočnika na seznamu kanalov.",
      channelNotFound: "Ustreznega kanala ni bilo mogoče najti. Osvežite seznam in poskusite znova.",
      pluginInstallTryLater:
        "Uradni vtičnik WeChat se trenutno namešča ali omogoča v ozadju. Poskusite znova čez nekaj trenutkov.",
      editNotSupported:
        "WeChat se poveže prek QR-kode, zato ga tukaj ni mogoče urejati. Če želite zamenjati račun, izbrišite ta kanal na strani kanalov in ga nato znova dodajte s skeniranjem.",
    },
  },
  common: {
    all: "全部",
