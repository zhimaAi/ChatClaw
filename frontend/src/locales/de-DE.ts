export default {
  ...
  channels: {
    ...
    unbindSuccess: "已解绑助手",
    wechat: {
      emptyTitle: "Noch kein WeChat-Konto hinzugefügt",
      emptyDesc: "Verbinde dein persönliches WeChat über das offizielle Tencent-OpenClaw-Plugin per QR-Code, um WeChat-Nachrichten zu empfangen und zu verarbeiten.",
      addNow: "Jetzt hinzufügen",
      configTitle: "WeChat konfigurieren",
      configSubtitle: "Verbinde dein persönliches WeChat über das offizielle Tencent-OpenClaw-Plugin per QR-Code",
      howToConnect: "So verbindest du dich",
      step1: "Verbinde dein persönliches WeChat über das offizielle Tencent-OpenClaw-Plugin per QR-Code.",
      step3: "Klicke auf „QR-Code generieren“. ClawX installiert und aktiviert das offizielle WeChat-Plugin in OpenClaw.",
      step4: "Scanne den QR-Code unten mit WeChat und bestätige die Verbindung auf deinem Telefon.",
      step5: "Nach erfolgreicher Verbindung erscheint in WeChat ein neuer Chat „WeChat ClawBot“. Über denselben QR-Code-Ablauf kannst du weitere Konten hinzufügen oder ein bestehendes Konto erneut verbinden.",
      configStepsLink: "Einrichtungsanleitung",
      generateQRCode: "QR-Code generieren",
      generating: "Wird generiert…",
      scanHint: "Scanne den QR-Code unten mit WeChat und bestätige die Verbindung auf deinem Telefon.",
      waitingForScan: "Warte auf Scan…",
      refresh: "Aktualisieren",
      loginSuccess: "WeChat erfolgreich verbunden!",
      assistantPromptTitle: "Assistent verknüpfen",
      assistantPromptDesc: "Standardmäßig wird der Hauptassistent (main) verknüpft und verarbeitet eingehende Nachrichten. Wenn du einen anderen Assistenten verwenden möchtest, kannst du einen bestehenden verknüpfen oder einen neuen erstellen und automatisch an diesen Kanal binden.",
      useMainAssistant: "Fertig (Hauptassistent verwenden)",
      bindExistingAssistant: "Bestehenden Assistenten binden",
      createAssistantManually: "Neuen Assistenten erstellen",
      createAssistantHint: "Beim Erstellen eines neuen Assistenten musst du Angaben wie den Namen weiterhin manuell eintragen. Nach dem Erstellen wird er automatisch gebunden und die Verbindung aktualisiert.",
      missingChannelId: "Kanalinformationen fehlen. Schließe diesen Dialog, aktualisiere die Kanalliste und versuche es erneut.",
      missingChannelIdHint: "Die Kanal-ID ist nicht verfügbar. Schließe diesen Dialog und binde einen Assistenten manuell über die Kanalliste.",
      channelNotFound: "Der zugehörige Kanal wurde nicht gefunden. Aktualisiere die Liste und versuche es erneut.",
      pluginInstallTryLater:
        "Das offizielle WeChat-Plugin wird im Hintergrund installiert oder aktiviert. Bitte versuche es in Kürze erneut.",
      editNotSupported:
        "WeChat wird per QR-Code verbunden und kann hier nicht bearbeitet werden. Um das Konto zu wechseln, lösche diesen Kanal auf der Kanäle-Seite und füge ihn per Scan erneut hinzu.",
    },
  },
  common: {
    all: "全部",
