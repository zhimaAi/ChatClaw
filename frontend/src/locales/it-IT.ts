export default {
  ...
  channels: {
    ...
    unbindSuccess: "已解绑助手",
    wechat: {
      emptyTitle: "Nessun account WeChat aggiunto",
      emptyDesc: "Collega il tuo WeChat personale tramite il plugin ufficiale Tencent OpenClaw scansionando un codice QR per iniziare a ricevere e gestire i messaggi WeChat.",
      addNow: "Aggiungi ora",
      configTitle: "Configura WeChat",
      configSubtitle: "Collega il tuo WeChat personale tramite il plugin ufficiale Tencent OpenClaw scansionando un codice QR",
      howToConnect: "Come collegarsi",
      step1: "Collega il tuo WeChat personale tramite il plugin ufficiale Tencent OpenClaw scansionando un codice QR.",
      step3: "Fai clic su \"Genera codice QR\". ClawX installerà e abiliterà il plugin ufficiale WeChat in OpenClaw.",
      step4: "Usa WeChat per scansionare il codice QR qui sotto e conferma la connessione sul telefono.",
      step5: "Dopo la connessione, in WeChat apparirà una nuova chat chiamata \"WeChat ClawBot\". Potrai ripetere la procedura con QR per aggiungere altri account o ricollegarne uno esistente.",
      configStepsLink: "Guida alla configurazione",
      generateQRCode: "Genera codice QR",
      generating: "Generazione in corso…",
      scanHint: "Usa WeChat per scansionare il codice QR qui sotto e conferma la connessione sul telefono.",
      waitingForScan: "In attesa della scansione…",
      refresh: "Aggiorna",
      loginSuccess: "WeChat collegato con successo!",
      assistantPromptTitle: "Collega assistente",
      assistantPromptDesc: "L’assistente principale (main) viene collegato per impostazione predefinita e gestirà i messaggi in arrivo. Se vuoi usare un altro assistente, puoi collegarne uno esistente oppure crearne uno nuovo e associarlo automaticamente a questo canale.",
      useMainAssistant: "Fatto (usa l’assistente principale)",
      bindExistingAssistant: "Collega un assistente esistente",
      createAssistantManually: "Crea un nuovo assistente",
      createAssistantHint: "Quando crei un nuovo assistente, dovrai comunque compilare manualmente dati come il nome. Dopo la creazione verrà collegato automaticamente e la connessione sarà aggiornata.",
      missingChannelId: "Informazioni sul canale mancanti. Chiudi questa finestra, aggiorna l’elenco dei canali e riprova.",
      missingChannelIdHint: "ID del canale non disponibile. Chiudi questa finestra e collega manualmente un assistente dall’elenco dei canali.",
      channelNotFound: "Canale corrispondente non trovato. Aggiorna e riprova.",
      pluginInstallTryLater:
        "Il plugin ufficiale WeChat si sta installando o attivando in background. Riprova tra un momento.",
      editNotSupported:
        "WeChat viene collegato tramite QR code e non può essere modificato qui. Per cambiare account, elimina questo canale dalla pagina dei canali e aggiungilo di nuovo tramite scansione.",
    },
  },
  common: {
    all: "全部",
