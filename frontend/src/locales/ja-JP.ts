export default {
  ...
  scheduledTasks: {
    ...
    form: {
      ...
      promptPlaceholder: "毎回の自動実行で送信するプロンプトを入力してください",
      selectAgent: "アシスタントを選択してください",
      selectProvider: "既定ではアシスタントに従う",
      selectModel: "既定ではアシスタント/プロバイダーに従う",
      noLibraries: "ナレッジベースが選択されていません",
      allLibraries: "{count} 個のナレッジベースを選択済み",
      daily: "毎日",
      weekly: "毎週",
      monthly: "毎月",
      interval: "X 分ごと",
      ...
      clear: "クリア",
      expiredHint: "このタスクは期限切れのため無効のままです。再度有効化するには、有効期限を未来の日時に変更してください。",
      expiresAt: "有効期限",
      monthOption: "{month}月",
    ...
    copy: "コピー",
    copySuffix: "コピー",
    expiredCannotEnable: "期限切れのため再度有効化できません",
    notification: {
      channelFallback: "チャンネル {id}",
      channelsLabel: "チャンネルを選択",
      emptyChannels: "現在の通知タイプで利用できるチャンネルはありません",
      hintSelected: "複数選択できます。タスク完了後、結果がこれらのチャンネルに送信されます。",
      hintUnselected: "まず通知タイプを選択し、その後対応するプラットフォームのチャンネルを1つ以上選んでください。",
      label: "通知",
      none: "通知を送信しない",
      optional: "任意",
      selectChannel: "チャンネルを選択してください",
      selectTypeFirst: "先に通知タイプを選択してください",
    },
    operationLog: {
      columns: {
        action: "操作",
