export default {
  ...
  channels: {
    ...
    unbindSuccess: "已解绑助手",
    wechat: {
      emptyTitle: "Nenhuma conta do WeChat foi adicionada ainda",
      emptyDesc: "Conecte seu WeChat pessoal pelo plugin oficial Tencent OpenClaw escaneando um QR code para começar a receber e processar mensagens do WeChat.",
      addNow: "Adicionar agora",
      configTitle: "Configurar WeChat",
      configSubtitle: "Conecte seu WeChat pessoal pelo plugin oficial Tencent OpenClaw escaneando um QR code",
      howToConnect: "Como conectar",
      step1: "Conecte seu WeChat pessoal pelo plugin oficial Tencent OpenClaw escaneando um QR code.",
      step3: "Clique em “Gerar QR Code”. O ClawX instalará e ativará o plugin oficial do WeChat no OpenClaw.",
      step4: "Use o WeChat para escanear o QR code abaixo e confirme a conexão no celular.",
      step5: "Depois da conexão, uma nova conversa chamada “WeChat ClawBot” aparecerá no WeChat. Você pode repetir o fluxo do QR code para adicionar mais contas ou reconectar uma conta existente.",
      configStepsLink: "Guia de configuração",
      generateQRCode: "Gerar QR code",
      generating: "Gerando…",
      scanHint: "Use o WeChat para escanear o QR code abaixo e confirme a conexão no celular.",
      waitingForScan: "Aguardando leitura…",
      refresh: "Atualizar",
      loginSuccess: "WeChat conectado com sucesso!",
      assistantPromptTitle: "Vincular assistente",
      assistantPromptDesc: "O assistente principal (main) fica vinculado por padrão e processará as mensagens recebidas. Se quiser usar outro assistente, você pode vincular um existente ou criar um novo e vinculá-lo automaticamente a este canal.",
      useMainAssistant: "Concluir (usar assistente principal)",
      bindExistingAssistant: "Vincular assistente existente",
      createAssistantManually: "Criar novo assistente",
      createAssistantHint: "Ao criar um novo assistente, você ainda precisará preencher manualmente informações como o nome. Depois de criado, ele será vinculado automaticamente e a conexão será atualizada.",
      missingChannelId: "As informações do canal estão ausentes. Feche esta janela, atualize a lista de canais e tente novamente.",
      missingChannelIdHint: "O ID do canal não está disponível. Feche esta janela e vincule manualmente um assistente pela lista de canais.",
      channelNotFound: "O canal correspondente não foi encontrado. Atualize e tente novamente.",
      pluginInstallTryLater:
        "O plugin oficial do WeChat está sendo instalado ou ativado em segundo plano. Tente novamente em instantes.",
      editNotSupported:
        "O WeChat é conectado por QR code e não pode ser editado aqui. Para trocar de conta, exclua este canal na página de canais e adicione-o novamente escaneando o código.",
    },
  },
  common: {
    all: "全部",
