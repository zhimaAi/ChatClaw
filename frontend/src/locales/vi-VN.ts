export default {
  ...
  channels: {
    ...
    unbindSuccess: "已解绑助手",
    wechat: {
      emptyTitle: "Chưa có tài khoản WeChat nào được thêm",
      emptyDesc: "Kết nối WeChat cá nhân của bạn qua plugin Tencent OpenClaw chính thức bằng cách quét mã QR để bắt đầu nhận và xử lý tin nhắn WeChat.",
      addNow: "Thêm ngay",
      configTitle: "Cấu hình WeChat",
      configSubtitle: "Kết nối WeChat cá nhân của bạn qua plugin Tencent OpenClaw chính thức bằng cách quét mã QR",
      howToConnect: "Cách kết nối",
      step1: "Kết nối WeChat cá nhân của bạn qua plugin Tencent OpenClaw chính thức bằng cách quét mã QR.",
      ...
      step5: "Sau khi kết nối thành công, một cuộc trò chuyện mới có tên “WeChat ClawBot” sẽ xuất hiện trong WeChat. Bạn có thể lặp lại quy trình bằng mã QR để thêm nhiều tài khoản hơn hoặc kết nối lại tài khoản hiện có.",
      configStepsLink: "Hướng dẫn thiết lập",
      ...
      refresh: "Làm mới",
      loginSuccess: "WeChat đã được kết nối thành công!",
      assistantPromptTitle: "Liên kết trợ lý",
      assistantPromptDesc: "Theo mặc định, trợ lý chính (main) sẽ được liên kết và xử lý các tin nhắn đến. Nếu bạn muốn dùng trợ lý khác, bạn có thể liên kết trợ lý hiện có hoặc tạo trợ lý mới và tự động gắn nó với kênh này.",
      useMainAssistant: "Hoàn tất (dùng trợ lý chính)",
      bindExistingAssistant: "Liên kết trợ lý hiện có",
      createAssistantManually: "Tạo trợ lý mới",
      createAssistantHint: "Khi tạo trợ lý mới, bạn vẫn cần tự nhập thủ công các thông tin như tên. Sau khi tạo xong, trợ lý sẽ được liên kết tự động và kết nối sẽ được làm mới.",
      missingChannelId: "Thiếu thông tin kênh. Hãy đóng cửa sổ này, làm mới danh sách kênh rồi thử lại.",
      ...
      pluginInstallTryLater:
        "Plugin WeChat chính thức đang được cài đặt hoặc kích hoạt ở nền. Vui lòng thử lại sau ít phút.",
      editNotSupported:
        "WeChat được kết nối bằng mã QR nên không thể chỉnh sửa tại đây. Nếu muốn đổi tài khoản, hãy xóa kênh này ở trang Kênh rồi quét mã để thêm lại.",
    },
  },
  common: {
    all: "全部",
