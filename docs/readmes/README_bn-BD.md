...
স্মার্ট অ্যাসিস্টেন্টে একটি বাক্যের কমান্ড পাঠান এবং স্বয়ংক্রিয়ভাবে PowerPoint প্রেজেন্টেশন তৈরি করুন।

![](../../images/2.png)

### স্কিল ম্যানেজার

কমান্ড ব্যবহার করে রোবটকে আপনার কম্পিউটারে ইনস্টল করা ফিচারগুলি খুঁজে বের করতে বা নতুন এক্সটেনশন প্লাগিন ইনস্টল করতে সাহায্য করুন।

![](../../images/3.png)

### নলেজ বেস | ডকুমেন্ট ভেক্টরাইজেশন স্টোরেজ

আপনার ডকুমেন্ট আপলোড করুন (যেমন TXT, PDF, Word, Excel, CSV, HTML, Markdown)। সিস্টেম স্বয়ংক্রিয়ভাবে পার্স, স্প্লিট এবং ভেক্টর এম্বেডিংয়ে রূপান্তর করবে, আপনার ব্যক্তিগত নলেজ বেসে সংরক্ষণ করবে যাতে AI মডেল সুনির্দিষ্ট রিট্রিভাল এবং ব্যবহার করতে পারে।

![](../../images/4.png)

### টেক্সট সিলেকশন ইনস্ট্যান্ট Q&A

আপনার স্ক্রিনে যেকোনো টেক্সট সিলেক্ট করুন, এটি স্বয়ংক্রিয়ভাবে কপি হয়ে ফ্লোটিং কুইক-আস্ক বক্সে ভরা হবে। এক ক্লিকে AI অ্যাসিস্টেন্টে পাঠান, তাৎক্ষণিক উত্তর পান।

![](../../images/5.png)

![](../../images/6.png)

### স্মার্ট স্ন্যাপ উইন্ডো

অন্যান্য অ্যাপ্লিকেশন উইন্ডোর পাশে স্ন্যাপ করতে পারে এমন একটি বুদ্ধিমান অ্যাসিস্টেন্ট। এর মধ্যে প্রশ্ন করার জন্য বিভিন্ন কনফিগারেড AI অ্যাসিস্টেন্টের মধ্যে দ্রুত সুইচ করুন। রোবট আপনার সংযুক্ত নলেজ বেসের উপর ভিত্তি করে উত্তর তৈরি করে এবং আপনার কথোপকথনে এক ক্লিকে রিপ্লাই পাঠানো সাপোর্ট করে।

![](../../images/7.png)

### এক প্রশ্ন, একাধিক উত্তর: সহজে তুলনা করুন

আপনার প্রশ্ন পুনরাবৃত্তি করতে হবে না। একই সাথে একাধিক "AI বিশেষজ্ঞদের" সাথে পরামর্শ করুন এবং তাদের উত্তরগুলি একই ইন্টারফেসে পাশাপাশি দেখুন। তুলনা করা সহজ এবং আপনাকে সেরা সিদ্ধান্তে পৌঁছাতে সাহায্য করে।

![](../../images/8.png)

### ওয়ান-ক্লিক লঞ্চার বল

আপনার ডেস্কটপে ফ্লোটিং বলে ক্লিক করলে ChatClaw মূল অ্যাপ্লিকেশন উইন্ডো ওয়েক আপ বা ওপেন হবে।
